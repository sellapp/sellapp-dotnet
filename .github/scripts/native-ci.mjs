    ...
    "commands": [
      ...
      },
      {
        ...
        "args": [
          ...
          "--configuration",
          "Release",
          "-p:SellAppPackageDirectory=$SDK_ROOT/.validation-package",
          "-p:RestorePackagesPath=$SDK_ROOT/.validation-package/consumer-packages"
        ]
      },
      {
        "stage": "documentation",
      ...
      },
      {
        ...
        "executable": "node",
        "args": [
          "$SDK_ROOT/.github/scripts/validate-dotnet-operation-snippets.mjs",
          "$SDK_ROOT"
        ]
      }
    ]
